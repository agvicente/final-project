...
- **Total de Experimentos**: 705
- **Tempo Total de Execução**: 224177.53 segundos (3736.3 minutos)
...
- **Accuracy**: 0.9827
- **F1-Score**: 0.9911
- **Eficiência**: 0.0077 F1/segundo

## 📋 Resultados Detalhados

| Algoritmo | Best Accuracy | Mean Accuracy | Best F1 | Mean F1 | Tempo (s) | Experimentos | Eficiência |
|-----------|---------------|---------------|---------|---------|-----------|--------------|------------|
| LogisticRegression | 0.9872 | 0.9870 | 0.9935 | 0.9934 | 3161.2 | 100 | 0.0003 |
| EllipticEnvelope | 0.9842 | 0.9811 | 0.9919 | 0.9902 | 1316.4 | 75 | 0.0008 |
| RandomForest | 0.9929 | 0.9923 | 0.9964 | 0.9961 | 53476.1 | 60 | 0.0000 |
| MLPClassifier | 0.9913 | 0.9909 | 0.9956 | 0.9953 | 48115.0 | 40 | 0.0000 |
| SGDOneClassSVM | 0.9827 | 0.9808 | 0.9911 | 0.9901 | 128.3 | 75 | 0.0077 |
| SGDClassifier | 0.9871 | 0.9861 | 0.9934 | 0.9929 | 2904.3 | 100 | 0.0003 |
| GradientBoostingClassifier | 0.9930 | 0.9922 | 0.9964 | 0.9960 | 88202.8 | 50 | 0.0000 |
| LocalOutlierFactor | 0.9824 | 0.9807 | 0.9909 | 0.9900 | 10921.2 | 40 | 0.0001 |
| LinearSVC | 0.9871 | 0.9870 | 0.9934 | 0.9934 | 14753.8 | 90 | 0.0001 |
| IsolationForest | 0.9805 | 0.8837 | 0.9900 | 0.9335 | 1198.4 | 75 | 0.0008 |
...
- **Tempo Médio por Algoritmo**: 22417.75s ± 30345.21s
- **Total de Experimentos Executados**: 705
...
- **Execuções por Configuração**: 5.0 (média)
...
- **Melhor Velocidade**: Use **SGDOneClassSVM** (128.29s)
