...
## 8. Cronograma de Experimentos

| Semana | Experimentos | Cenários |
|--------|--------------|----------|
| **S7** | Primeiros experimentos | A (Detecção básica) |
| **S8** | Experimentos drift | B, C (Súbito, Gradual) |
| **S9** | Comparação Fase 1 | A + comparativo batch |
| **S11** | Full dataset | Todos os cenários |
| **S12** | Análise concept drift | B, C, D completos |
