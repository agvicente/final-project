...
### Commits
- c6c77be chore: prepare cross-machine handoff — cleanup plan + fix context files

### Files Modified
- .claude/skills/iot-ids-research-context/SKILL.md
- CLAUDE.md
- README.md
- STATUS.md
- docs/plans/2026-03-09-cleanup-old-paths.md
- docs/progress/2026-03-09-session-18:39.md
- experiments/campaign-plan.md
