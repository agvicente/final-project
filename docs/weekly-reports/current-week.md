...
|---|------------|--------|---------|
| 1 | Fichamento Angelov (2014) | ⏳ | `docs/paper-summaries/angelov-2014-teda.md` |
...
- [ ] Ler paper completo: "Outside the box: an alternative data analytics framework"
- [ ] Criar fichamento seguindo template
- [ ] Extrair fórmulas e pseudocódigo
...
- [ ] Motivação do framework TEDA
- [ ] Definição formal de eccentricidade
- [ ] Definição formal de tipicalidade
